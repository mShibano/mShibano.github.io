...
var atlantis_json_1 = require("../../../public/tiles/atlantis.json");
...
var Game = /** @class */ (function (_super) {
    ...
    Game.prototype.create = function () {
        ...
        var waterfall = this.sound.add("waterfall");
        var musicConfig = {
            mute: false,
            volume: 0.02,
            rate: 1,
        ...
        this.cursors.space.on("down", function () {
            console.log(atlantis_json_1["default"]);
            console.log(helper_1.displayInventory);
            (0, helper_1.interact)(_this.message, _this.player, atlantis_json_1["default"].layers[3].objects, item);
        });
    ...
    Game.prototype.playDialogue = function () {
        ...
        (0, helper_1.dialogueArea)(17, 143, 230, 337, grabShovel, this.player, this.message);
