...
var maze_json_1 = require("../../public/tiles/maze.json");
var mazeExits = [
...
var Game = /** @class */ (function (_super) {
    ...
    Game.prototype.create = function () {
        ...
        this.cursors.space.on("down", function () {
            console.log(maze_json_1["default"]);
            (0, helper_1.interact)(_this.message, _this.player, maze_json_1["default"].layers[3].objects, _this.sound.add("item"));
        }),
    ...
    Game.prototype.exits = function () {
        var nextToTarget = (0, helper_1.isItClose)(this.player, mazeExits);
        if (nextToTarget) {
