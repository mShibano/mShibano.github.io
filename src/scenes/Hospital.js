...
var hospital_json_1 = require("../../public/tiles/hospital.json");
/**
...
var Game = /** @class */ (function (_super) {
    ...
    Game.prototype.create = function () {
        ...
        this.cursors.space.on("down", function () {
            console.log(hospital_json_1["default"]);
            console.log(helper_1.displayInventory);
            (0, helper_1.interact)(_this.message, _this.player, hospital_json_1["default"].layers[4].objects, _this.sound.add("item"));
        }),
    ...
    Game.prototype.exits = function () {
        ...
        var nextToTarget = (0, helper_1.isItClose)(this.player, hospitalExits);
        if (nextToTarget) {
    ...
    Game.prototype.spawn = function () {
        if (localStorage["from"] === "overworld") {
            ...
            this.player = this.physics.add.sprite(105, 530, "player", "doc-walk-up-0");
        }
        else if (localStorage["Brain Scan"] === "A beautiful mind.") {
            localStorage.removeItem("from");
            this.player = this.physics.add.sprite(349, 85, "player", "doc-walk-side-0");
            ...
            "Too blurry! The doctor can't interpret this.") {
            localStorage.removeItem("from");
            this.player = this.physics.add.sprite(359.5, 84, "player", "doc-walk-side-0");
        }
    };
    return Game;
