...
exports.overworldExits = void 0;
var phaser_1 = require("phaser");
//import data from "../tiles/overworld.json";
var overworld_json_1 = require("../../public/tiles/overworld.json");
...
var dialogue = [
    ...
    },
    {
        ...
        properties: [
            {
                name: "message",
                value: "I'm out! Finally. Now, about this pounding.. There's gotta be a hospital around here. Say.. what a nice town. Aren't there any people?"
            },
        ],
        hasAppeared: false
    },
    ...
    },
    {
        properties: [
            {
                name: "message",
                value: "Whew. I could use a drink... Maybe that doctor's drink I smuggled will do. Ooh... yes that's good. I feel more energized!"
            },
        ],
        hasAppeared: false
    },
...
var Game = /** @class */ (function (_super) {
    ...
    Game.prototype.create = function () {
        ...
        this.cursors.space.on("down", function () {
            console.log(overworld_json_1["default"]);
            (0, helper_1.interact)(_this.message, _this.player, overworld_json_1["default"].layers[5].objects, item);
        }),
    ...
    Game.prototype.spawn = function () {
        ...
        */
        if (localStorage.from === "hospital") {
            ...
            this.player = this.physics.add.sprite(1250, 526, "player", "doc-walk-down-0");
        }
        else if (localStorage.from === "shop") {
            localStorage.removeItem("from");
            this.player = this.physics.add.sprite(320, 1220, "player", "doc-walk-down-0");
        }
        else if (localStorage.from === "home") {
            localStorage.removeItem("from");
            this.player = this.physics.add.sprite(788, 1100, "player", "doc-walk-down-0");
        }
        else if (localStorage.from === "atlantis") {
            localStorage.removeItem("from");
            this.player = this.physics.add.sprite(808, 240, "player", "doc-walk-down-0");
        }
        else {
            this.player = this.physics.add.sprite(800, 800, "player", "doc-walk-down-0");
        }
    };
    Game.prototype.playDialogue = function () {
        ...
        (0, helper_1.dialogueArea)(704, 890, 1163, 1337, toHospital, this.player, this.message);
        if (localStorage["Dr. Cola"] === "A yummy fizzy drink that doctors love!" &&
            !hasSoda.hasAppeared) {
    ...
    Game.prototype.exits = function () {
        ...
        var exit = (0, helper_1.isItClose)(this.player, exports.overworldExits);
        if (exit) {
            if (exit.scroll) {
